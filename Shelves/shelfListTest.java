...
public class shelfListTest {
    ...
    public void testAddProduct() {  
        ...
        myShelf.addProduct(0,"Milk",100); // location,name,amount
        myShelf.addProduct(1,"Juice",100);
        myShelf.addProduct(2,"Bread",100); // this should add the existing value
        myShelf.addProduct(3,"Cheese",100);
